...
namespace PreSchool
{
    public partial class FormChildMenu : Form
    {
        ...
        private void RadioBtnLocation(int pos)
        {
        ...
        private Child GetChildFromComboBox()
        {
            ...
            var child = db.Children.Include("Groups").First(p => p.FirstName == childName[0] && p.LastName == childName[1]);
            return child;
        }
        private void ChangeTextBoxesText()
        {
            ...
            //no Idea how to set combobox selection to match a string input so I leave that one alone
        }
    }
}
